      ...
      <section className="home-hero">
        ...
        <div className="container home-hero-grid">
          <div key={heroMode} className={`home-hero-copy hero-mode-copy ${heroMode}`}>
            {heroMode === 'legacy' ? <><span className="eyebrow">PALM MERIT GLOBAL</span><h1><span>Unlocking Potential,</span><em>Restoring Hope.</em></h1><p>Palm Merit Global is a humanitarian cooperative dedicated to touching lives, empowering communities, and ensuring dignity for all vulnerable families.</p><div className="hero-actions"><Link to="/register" className="btn btn-accent">Join the Community <FaArrowRight /></Link><Link to="/about" className="text-link">Our mission <FaArrowRight /></Link></div><div className="hero-proof"><span><FaCheck /> Humanitarian support</span><span><FaCheck /> Community empowerment</span></div></> : <><span className="eyebrow">PALM MERIT COOPERATIVE</span><h1><span>Save with purpose.</span><em>Grow with merit.</em></h1><p>A structured cooperative community helping members build meaningful savings, reach personal targets, and create a stronger tomorrow together.</p><div className="hero-actions"><Link to="/register" className="btn btn-accent">Get Started <FaArrowRight /></Link><a href="#plans" className="text-link">Explore plans <FaArrowRight /></a></div><div className="hero-proof"><span><FaCheck /> Community-led</span><span><FaCheck /> Clear programme rules</span></div></>}
          </div>
