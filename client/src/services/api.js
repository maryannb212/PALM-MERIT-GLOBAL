...
export const updateBvn = (bvn) => API.post('/auth/update-bvn', { bvn });
...
export const clearDefaults = () => API.post('/savings/clear-defaults');
export const clearDefaultById = (defaultId) => API.post(`/savings/clear-default/${defaultId}`);
